...
from test.src.tests.jobs import do_monthly_user_site_hits_transformation
from collections import namedtuple

MonthlySiteHit = namedtuple("MonthlySiteHit", "month_start hit_array date_partition")
MonthlySiteHitsAgg = namedtuple(
    "MonthlySiteHitsAgg",
...
def test_monthly_site_hits(spark):
    ...
    input_data = [
        ...
        MonthlySiteHit(month_start=new_month_start, hit_array=[], date_partition=ds),
        # Make sure other partitions get filtered
        MonthlySiteHit(month_start=new_month_start, hit_array=[], date_partition=""),
    ]
